...
- [X] T048 [P] [US1] Create `client/src/screens/Review.tsx` (S2: full order and total, Continue to payment, Back, Start new order) and `client/src/screens/Payment.tsx` (S3: "Simulated payment" heading and copy, total, Approve/Decline/No answer selector defaulting to Approve, primary Pay, Back before send, Start new order)
